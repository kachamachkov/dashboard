...
For dev environment (on both client/server):
- npm run dev
- Local production environment is served on: http://localhost:4173/
- Local development environment is served on http://localhost:5173/
